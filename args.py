...
val_evaluation_epoch = 3  # Evaluate on the whole validation dataset after some steps. Set to None to evaluate every epoch.
save_epoch = 8  # Save the model after some epochs.
...
gamma = 1e-4
prune_factor = 0.8
nb_finetune_epochs = 3
maximum_pruning_percent = 0.75
maximum_prune_iterations = 3
sliming_restore_path = '/home/lovepan/work/YOLOv3_TensorFlow/sliming_checkpoint/sliming_prune_model_darknet_yolo_head.ckpt'
sliming_eval_epoch = 1
sliming_save_dir = './sliming_checkpoint/'
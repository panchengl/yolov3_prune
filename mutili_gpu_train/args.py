...
save_dir = root + '/mutili_gpu_train/checkpoint/'  # The directory of the weights to save.
log_dir = root + '/mutili_gpu_train/data/logs/'  # The directory to store the tensorboard log files.

...
with tf.Session() as sess:
    ...
    #     # for i in trange(args.train_batch_num // args.NUM_GPU):
    #     for i in trange(1):
    #         a, b, c, d, e = sess.run(
    #             [image_ids, image, y_true_13, y_true_26, y_true_52] )
    #         print('image_ids is', a)
    #         print('image is', b.shape)
    #         print("y_true_13 is", c)

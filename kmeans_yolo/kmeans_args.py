...
finetune_restore_path = root + '/dinali_608/kmeans_checkpoint/kmeans_prune_restore_model_all.ckpt'
save_dir =root + '/dinali_608/kmeans_checkpoint/'  # The directory of the weights to save.

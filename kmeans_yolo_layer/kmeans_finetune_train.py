...
import kmeans_yolo_layer.kmeans_args as args
...
shortcut_list = [1, 2, 8, 7, 1]
yolo_model = sparse_yolov3_shortcut(args.class_num, args.anchors, shortcut_list, args.use_label_smooth, args.use_focal_loss, args.batch_norm_decay, args.weight_decay)
############################## first prune #################################################################################
with tf.variable_scope('yolov3'):
    pred_feature_maps = yolo_model.forward(image, is_training=is_training)
############################################################################################################################
...
with tf.Session() as sess:
    ...
    saver_to_restore.restore(sess, args.finetune_restore_path)

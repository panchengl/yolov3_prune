...
# restore_path = root + '/sft_yolo/soft_prun_checkpoint/best_model_Epoch_5_step_8279_mAP_0.6439_loss_4.4991_lr_0.0001'  # The path of the weights to restore.
restore_path = root + '/data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
# finetune_restore_path = root + '/sliming_yolo/sliming_checkpoint/sliming_prune_model_darknet_yolo_head_fourth.ckpt'
save_dir =root + '/sft_yolo/checkpoint/'  # The directory of the weights to save.

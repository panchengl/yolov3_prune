...
import sliming_yolo.sliming_args as args
...
with tf.Session() as sess:
    ...
    for epoch in range(args.total_epoches):
        ...
        if epoch % args.val_evaluation_epoch == 0 and epoch > 0:
            ...
            if mAP > best_mAP:
                best_mAP = mAP
                saver_best.save(sess, './sliming_yolo/sliming_checkpoint/' + 'best_model_Epoch_{}_step_{}_mAP_{:.4f}_loss_{:.4f}_lr_{:.7g}'.format(

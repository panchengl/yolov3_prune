...
save_dir = root + '/quant_yolo/checkpoint/'  # The directory of the weights to save.
log_dir = root + '/quant_yolo/data/logs/'  # The directory to store the tensorboard log files.

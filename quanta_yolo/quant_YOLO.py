...
from quant_yolo.YOLOv3 import yolov3_model
...
img_name = '/home/pcl/tf_work/my_github/yolov3_prune/img_dir/000001.jpg'
...
img = cv2.resize(img_ori, input_size)
...
class YOLO_train(object):
	...
	'''
	def __init__(self):
		self.saved_weight             = args.save_dir

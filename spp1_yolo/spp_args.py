...
# restore_path = root + '/checkpoint/best_model_Epoch_12_step_35866_mAP_0.8411_loss_4.7781_lr_1e-05'  # The path of the weights to restore.
restore_path = root + '/data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = root + '/spp1_yolo/checkpoint/'  # The directory of the weights to save.
